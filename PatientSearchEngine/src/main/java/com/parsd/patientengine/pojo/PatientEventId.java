...
/**
 * PatientEventId generated by hbm2java
 */
public class PatientEventId  implements java.io.Serializable {
    ...
    public PatientEventId() {
    }

    public PatientEventId(String patientUpi, int doctorId, Date eventDate) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PatientEventId) ) return false;
		 PatientEventId castOther = ( PatientEventId ) other; 
