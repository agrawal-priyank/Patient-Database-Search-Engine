...
/**
 * VitalSignsId generated by hbm2java
 */
@Embeddable
public class VitalSignsId  implements java.io.Serializable {
    ...
    public VitalSignsId(String patientUpi, int doctorId, Date eventDate) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof VitalSignsId) ) return false;
		 VitalSignsId castOther = ( VitalSignsId ) other; 
