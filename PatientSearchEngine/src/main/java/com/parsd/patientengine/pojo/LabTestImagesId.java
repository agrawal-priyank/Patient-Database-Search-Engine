...
/**
 * LabTestImagesId generated by hbm2java
 */
@Embeddable
public class LabTestImagesId  implements java.io.Serializable {
    ...
    public LabTestImagesId() {
    }

    public LabTestImagesId(String patientUpi, int doctorId, Date eventDate, int testId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LabTestImagesId) ) return false;
		 LabTestImagesId castOther = ( LabTestImagesId ) other; 
