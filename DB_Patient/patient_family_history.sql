...
CREATE TABLE `family_history` (
  ...
  CONSTRAINT `patient_has_familyhistory` FOREIGN KEY (`patient_UPI`) REFERENCES `patient` (`patient_UPI`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `family_history` VALUES ('089b1a','Rajat','Friend',20,'Y','Healthy','No',0),('6fdb24','Rajat','Brother',35,'Y','Healthy','N/A',0),('c0bb51','Arvind','Parent',15,'N','Unhealthy','N/A',20);
